  ...
  */
  ...
  <div class="modal fade" id="myModalup' . $row['idRepresentante'] . '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    public function InsertRepresentante($NomeRepresentante, $TelefoneRepresentante, $EmailRepresentante, $Fabricante_idFabricante, $idUsuario)
    {
      ...
      $query = "INSERT INTO `representante`(`idRepresentante`, `NomeRepresentante`, `TelefoneRepresentante`, `EmailRepresentante`,`repAtivo`,`repPublic`, `Fabricante_idFabricante`, `Usuario_idUsuario`) VALUES (NULL, '$NomeRepresentante', '$TelefoneRepresentante', '$EmailRepresentante', 1, 1, '$Fabricante_idFabricante', '$idUsuario')";
    ...
    {
      $query = "UPDATE `representante` SET `NomeRepresentante`='$NomeRepresentante',`TelefoneRepresentante`='$TelefoneRepresentante',`EmailRepresentante`='$EmailRepresentante',`Usuario_idUsuario`='$idUsuario' WHERE `idRepresentante` = '$idRepresentante'";
