...
*/
$url = 'http://localhost/Almoxarifado/views/'; // Remova em caso de utilizar o código para hospedagem web 
...
<head>
  ...
  <title>MACSOFTWARE | PROJETOS</title>
  ...
  function processarDados(data) {
    ...
    document.getElementById(\'valor\').value = valor;    
      ...
      $("#codigo").keyup(function(){  
           ...
           {  
                $.ajax({  
                     url:"' . $url . '../App/Database/searchproducts2.php",  
                     method:"POST",  
                     data:{codigo:codigo},  
                     success:function(data)  
                     { 
                      let objeto = JSON.parse(data);
                      processarDados(objeto);
...
function carregartabela(){
  $.ajax({
    type: "GET",
    url: "' . $url . '../App/Database/obterCarrinho.php",
    success: function(data){
...
$header = '<header class="main-header">
    ...
    <a href="' . $url . '" class="logo">
      ...
      <span class="logo-mini"><b>MAC</b>PROJETOS</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>MAC</b>PROJETOS</span>
    </a>
...
<!-- Produtos -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="' . $url . 'produtos/addprod.php"><i class="fa fa-circle-o"></i>Novo Centro</a></li>
            <li><a href="' . $url . 'produtos/"><i class="fa fa-circle-o"></i>Centros</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="' . $url . 'fabricante/"><i class="fa fa-circle-o"></i>Projetos</a></li>
            <li><a href="' . $url . 'fabricante/addfabricante.php"><i class="fa fa-circle-o"></i>Novo Projeto</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="' . $url . 'fabricante/"><i class="fa fa-circle-o"></i>Novo Material</a></li>
            <li><a href="' . $url . 'fabricante/addfabricante.php"><i class="fa fa-circle-o"></i>Materiais</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="' . $url . 'fabricante/"><i class="fa fa-circle-o"></i>Abrir Projeto</a></li>
            <li><a href="' . $url . 'fabricante/addfabricante.php"><i class="fa fa-circle-o"></i>Projetos Separados</a></li>
          </ul>
        </li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="' . $url . 'relatorios/relatoriovendas.php"><i class="fa fa-circle-o"></i>Relatorios Vendas</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="' . $url . 'vendas/"><i class="fa fa-circle-o"></i>Certificar</a></li>
...
$footer = '<footer class="main-footer">
    ...
    <strong>MacProduções 2024</strong> - Todos os Direitos Reservados
  </footer>
