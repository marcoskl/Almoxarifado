...
*/
$url = 'http://localhost/SistemaVendas-Marcos/views/'; // Remova em caso de utilizar o código para hospedagem web 
...
<!-- Produtos -->
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="' . $url . 'produtos/"><i class="fa fa-circle-o"></i>Produtos</a></li>
            <li><a href="' . $url . 'produtos/addprod.php"><i class="fa fa-circle-o"></i>Add Produtos</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="' . $url . 'carteira/"><i class="fa fa-circle-o"></i>Carteira</a></li>          
            </ul>
        </li>
